...
const LandingPage = () => {
  const features = [
    ...
    { icon: Target, title: 'Smart Placement Engine', description: 'Personalized job recommendations based on your unique skill profile.', gradient: 'linear-gradient(135deg, #2E073F 0%, #ec4899 100%)' },
    ...
    { icon: Route, title: 'Adaptive Learning Paths', description: 'Personalized learning journeys that adapt based on your progress.', gradient: 'linear-gradient(135deg, #2E073F 0%, #2E073F 100%)' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #faf5ff 0%, #f5f3ff 50%, #ede9fe 100%)', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{
        ...
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.5rem', fontWeight: 700, color: '#2E073F', textDecoration: 'none' }}>
          <Sparkles size={28} />
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
          ...
          <Link to="/register" style={{
            background: 'linear-gradient(135deg, #2E073F 0%, #2E073F 100%)', color: 'white',
        ...
        <div style={{
          ...
          >
            <div style={{
              ...
              color: '#2E073F', padding: '0.5rem 1rem', borderRadius: '50px',
            ...
            <h1 style={{ fontSize: '3.5rem', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.5rem', color: '#1f2937' }}>
              ...
              <span style={{
                background: 'linear-gradient(135deg, #2E073F 0%, #2E073F 50%, #a78bfa 100%)',
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              <button style={{
                background: 'white', color: '#2E073F', padding: '1rem 2rem', borderRadius: '14px',
              ...
              {[
                ...
                <div key={skill.name} style={{ marginBottom: '1rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: 500, color: '#374151' }}>
                    ...
                    <span style={{ color: '#2E073F' }}>{skill.value}%</span>
                  </div>
                  <div style={{ height: '10px', background: '#f5f3ff', borderRadius: '5px', overflow: 'hidden' }}>
                    <motion.div
                      style={{ height: '100%', background: 'linear-gradient(90deg, #2E073F 0%, #2E073F 100%)', borderRadius: '5px' }}
                      initial={{ width: 0 }}
      ...
      {/* Stats Section */}
      <section id="stats" style={{ padding: '5rem 2rem', background: 'linear-gradient(135deg, #2E073F 0%, #2E073F 100%)' }}>
        <div style={{
          maxWidth: '1200px', margin: '0 auto', display: 'grid',
