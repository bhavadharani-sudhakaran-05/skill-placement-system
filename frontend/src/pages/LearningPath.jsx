...
<body>
  ...
  const styles = {
    ...
    pathCard: (selected) => ({
      ...
      borderRadius: '16px', padding: '1rem', cursor: 'pointer', transition: 'all 0.3s',
      border: selected ? 'none' : '1px solid #ede9fe', boxShadow: selected ? '0 8px 25px rgba(139,92,246,0.3)' : '0 2px 10px rgba(139,92,246,0.08)'
    }),
    pathHeader: { display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' },
    pathIcon: { fontSize: '1.25rem' },
    pathTitle: (selected) => ({ fontSize: '1rem', fontWeight: 600, color: selected ? 'white' : '#1f2937' }),
    pathStats: (selected) => ({ display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: selected ? 'rgba(255,255,255,0.9)' : '#6b7280', fontSize: '0.8rem', marginBottom: '0.5rem' }),
    pathMeta: (selected) => ({ display: 'flex', gap: '0.75rem', fontSize: '0.7rem', color: selected ? 'rgba(255,255,255,0.8)' : '#9ca3af' }),
    ...
    skillGapCard: { background: 'white', borderRadius: '16px', padding: '1rem', marginTop: '0.75rem', boxShadow: '0 2px 10px rgba(139,92,246,0.08)', border: '1px solid #ede9fe' },
    skillGapTitle: { fontSize: '0.95rem', fontWeight: 700, color: '#1f2937', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.5rem' },
    ...
    recsCard: { background: 'linear-gradient(135deg, #f5f3ff, #ede9fe)', borderRadius: '16px', padding: '1rem', marginTop: '0.75rem', border: '2px solid #c4b5fd' },
    recsTitle: { fontSize: '0.95rem', fontWeight: 700, color: '#5b21b6', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.5rem' },
    recItem: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.65rem', background: 'white', borderRadius: '10px', marginBottom: '0.4rem' },
    recIcon: { fontSize: '1rem' },
    recInfo: { flex: 1 },
    recTitle: { fontWeight: 600, fontSize: '0.8rem', color: '#1f2937' },
    recImpact: { fontSize: '0.7rem', color: '#10b981', fontWeight: 500 },
    recBtn: { padding: '0.35rem 0.6rem', background: 'linear-gradient(135deg, #7c3aed, #8b5cf6)', color: 'white', border: 'none', borderRadius: '6px', fontSize: '0.7rem', fontWeight: 600, cursor: 'pointer' },
    mainContent: { display: 'flex', flexDirection: 'column', gap: '1.5rem' },
    progressCard: { background: 'white', borderRadius: '18px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(139,92,246,0.08)', display: 'flex', gap: '1.5rem', alignItems: 'center', border: '1px solid #ede9fe' },
    progressCircle: { width: '120px', height: '120px', flexShrink: 0 },
    progressInfo: { flex: 1 },
    progressTitle: { fontSize: '1.3rem', fontWeight: 700, color: '#1f2937', marginBottom: '0.5rem' },
    progressSubtitle: { color: '#6b7280', marginBottom: '0.75rem', fontSize: '0.95rem' },
    ...
    certsBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.65rem 1rem', background: 'linear-gradient(135deg, #7c3aed, #8b5cf6)', color: 'white', border: 'none', borderRadius: '10px', fontWeight: 600, cursor: 'pointer', marginTop: '0.75rem', boxShadow: '0 4px 15px rgba(139,92,246,0.3)', fontSize: '0.9rem' },
    section: { background: 'white', borderRadius: '18px', padding: '1.25rem', boxShadow: '0 4px 20px rgba(139,92,246,0.08)', border: '1px solid #ede9fe' },
    ...
    milestoneContent: (status) => ({
      ...
      borderRadius: '12px', padding: '0.875rem', border: status === 'in-progress' ? '2px solid #7c3aed' : status === 'completed' ? '2px solid #10b981' : '1px solid #ede9fe', cursor: 'pointer', transition: 'all 0.2s'
    }),
    ...
    coursesList: { display: 'flex', flexDirection: 'column', gap: '0.75rem' },
    courseItem: { display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.875rem', background: '#faf5ff', borderRadius: '12px', border: '1px solid #ede9fe' },
    courseIcon: { width: '40px', height: '40px', borderRadius: '10px', background: 'linear-gradient(135deg, #7c3aed 0%, #8b5cf6 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '1.25rem' },
    courseInfo: { flex: 1 },
    courseTitle: { fontWeight: 600, color: '#1f2937', marginBottom: '0.25rem', fontSize: '0.95rem' },
    courseMeta: { display: 'flex', gap: '1rem', fontSize: '0.75rem', color: '#6b7280' },
    ...
    continueBtn: { padding: '0.45rem 0.85rem', borderRadius: '10px', border: 'none', background: 'linear-gradient(135deg, #7c3aed 0%, #8b5cf6 100%)', color: 'white', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.75rem', boxShadow: '0 4px 12px rgba(139,92,246,0.25)' },
    ...
    enrollBtn: { marginTop: '1rem', padding: '0.75rem 1.5rem', background: 'linear-gradient(135deg, #7c3aed, #8b5cf6)', color: 'white', border: 'none', borderRadius: '10px', fontWeight: 600, cursor: 'pointer' }
  };
