...
const Jobs = () => {
  ...
  const styles = {
    ...
    jobsGrid: { display: 'grid', gap: '1.5rem' },
    jobCard: { background: 'white', borderRadius: '20px', padding: '1.75rem', boxShadow: '0 4px 20px rgba(139, 92, 246, 0.08)', border: '1px solid #ede9fe', transition: 'all 0.3s' },
    ...
    companyLogo: (color) => ({ width: '56px', height: '56px', borderRadius: '14px', background: `linear-gradient(135deg, ${color || '#7c3aed'} 0%, ${color || '#8b5cf6'}cc 100%)`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700, fontSize: '1.25rem' }),
    jobTitle: { fontSize: '1.35rem', fontWeight: 700, color: '#1f2937', marginBottom: '0.25rem' },
    ...
    description: { color: '#6b7280', marginBottom: '1rem', lineHeight: 1.6, fontSize: '0.95rem' },
    ...
    metaRow: { display: 'flex', gap: '1.5rem', flexWrap: 'wrap', marginBottom: '1.25rem' },
    ...
    applyButton: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem 1.5rem', borderRadius: '12px', border: 'none', background: 'linear-gradient(135deg, #7c3aed 0%, #8b5cf6 100%)', color: 'white', fontWeight: 600, cursor: 'pointer', textDecoration: 'none', fontSize: '0.9rem', transition: 'all 0.2s', boxShadow: '0 4px 15px rgba(139, 92, 246, 0.3)' },
