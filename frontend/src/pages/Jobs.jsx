...
const Jobs = () => {
  ...
  const styles = {
    ...
    companyLogo: (color) => ({ width: '36px', height: '36px', borderRadius: '10px', background: `linear-gradient(135deg, ${color || '#2E073F'} 0%, ${color || '#2E073F'}cc 100%)`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700, fontSize: '0.9rem' }),
    ...
    matchBadge: (match) => ({ padding: '0.3rem 0.65rem', borderRadius: '20px', fontWeight: 600, fontSize: '0.7rem', background: match >= 90 ? 'linear-gradient(135deg, #2E073F 0%, #2E073F 100%)' : match >= 80 ? 'linear-gradient(135deg, #a78bfa 0%, #c4b5fd 100%)' : match >= 70 ? 'linear-gradient(135deg, #c4b5fd 0%, #ddd6fe 100%)' : '#f5f3ff', color: match >= 70 ? 'white' : '#2E073F' }),
    ...
    skillTag: { padding: '0.25rem 0.6rem', background: '#f5f3ff', color: '#2E073F', borderRadius: '15px', fontSize: '0.7rem', fontWeight: 500 },
