...
const Analytics = () => {
  ...
  const styles = {
    ...
    contributionCard: { background: 'white', borderRadius: '20px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(139, 92, 246, 0.08)', marginBottom: '2rem', border: '1px solid #ede9fe' },
    contributionHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
    contributionTitle: { fontSize: '1.15rem', fontWeight: 700, color: '#1f2937', display: 'flex', alignItems: 'center', gap: '0.5rem' },
    contributionGraph: { overflowX: 'auto', paddingBottom: '0.5rem' },
    contributionContainer: { display: 'flex', gap: '3px', minWidth: 'fit-content' },
    contributionLabels: { display: 'flex', flexDirection: 'column', gap: '3px', marginRight: '8px', paddingTop: '20px' },
    contributionDayLabel: { fontSize: '10px', color: '#6b7280', height: '11px', lineHeight: '11px' },
    contributionWeeksContainer: { display: 'flex', flexDirection: 'column' },
    contributionMonths: { display: 'flex', marginBottom: '4px', fontSize: '10px', color: '#6b7280' },
    contributionWeeks: { display: 'flex', gap: '3px' },
    contributionWeek: { display: 'flex', flexDirection: 'column', gap: '3px' },
    contributionDay: { width: '11px', height: '11px', borderRadius: '2px', cursor: 'pointer' },
    contributionLegend: { display: 'flex', alignItems: 'center', gap: '4px', marginTop: '1rem', justifyContent: 'flex-end' },
    contributionLegendText: { fontSize: '11px', color: '#6b7280', marginRight: '4px' }
  };
