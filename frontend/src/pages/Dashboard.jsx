...
const styles = {
  ...
  content: { padding: '1.25rem 1.5rem', maxWidth: '1400px', margin: '0 auto' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  greeting: { fontSize: '1.4rem', fontWeight: 700, color: '#7c3aed', margin: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' },
  subGreeting: { fontSize: '0.85rem', color: '#6b7280', margin: '0.3rem 0 0', display: 'flex', alignItems: 'center', gap: '0.3rem' },
  timeCard: { display: 'flex', flexDirection: 'column', alignItems: 'flex-end', background: 'white', padding: '0.6rem 1rem', borderRadius: '10px', boxShadow: '0 2px 12px rgba(139,92,246,0.1)', border: '1px solid #ede9fe' },
  time: { fontSize: '1.1rem', fontWeight: 700, color: '#7c3aed' },
  date: { fontSize: '0.75rem', color: '#9ca3af' },
  ticker: { display: 'flex', alignItems: 'center', gap: '0.6rem', background: 'linear-gradient(135deg, #7c3aed, #8b5cf6)', borderRadius: '10px', padding: '0.5rem 1rem', marginBottom: '1rem', color: 'white', fontSize: '0.8rem', overflow: 'hidden' },
  tickerScroll: { display: 'flex', gap: '2rem', whiteSpace: 'nowrap' },
  tickerItem: { display: 'flex', alignItems: 'center', gap: '0.3rem' },
  mainGrid: { display: 'grid', gridTemplateColumns: '200px 1fr 200px', gap: '1rem' },
  ...
  scoreCard: { background: 'white', borderRadius: '14px', padding: '1rem', boxShadow: '0 4px 16px rgba(139,92,246,0.1)', border: '1px solid #ede9fe', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.6rem' },
  scoreTitle: { fontSize: '0.8rem', fontWeight: 600, color: '#374151', display: 'flex', alignItems: 'center', gap: '0.3rem' },
  scoreCircle: { width: '90px', height: '90px' },
  scoreLabel: { fontSize: '0.8rem', fontWeight: 600, color: '#7c3aed' },
  card: { background: 'white', borderRadius: '12px', padding: '0.85rem', boxShadow: '0 3px 12px rgba(139,92,246,0.08)', border: '1px solid #ede9fe', display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.25rem' },
  cardTitle: { fontSize: '0.85rem', fontWeight: 600, color: '#374151', display: 'flex', alignItems: 'center', gap: '0.35rem' },
  link: { fontSize: '0.75rem', color: '#7c3aed', textDecoration: 'none', display: 'flex', alignItems: 'center', fontWeight: 500 },
  btn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.35rem', padding: '0.55rem 0.75rem', borderRadius: '8px', background: 'linear-gradient(135deg, #7c3aed, #8b5cf6)', color: 'white', fontSize: '0.8rem', fontWeight: 600, textDecoration: 'none', border: 'none', cursor: 'pointer', marginTop: '0.4rem' },
  btnSecondary: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.35rem', padding: '0.5rem', borderRadius: '8px', background: 'linear-gradient(135deg, #8b5cf6, #a78bfa)', color: 'white', fontSize: '0.75rem', fontWeight: 600, textDecoration: 'none' },
  btnOutline: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.35rem', padding: '0.5rem', borderRadius: '8px', background: '#ede9fe', color: '#7c3aed', fontSize: '0.75rem', fontWeight: 600, textDecoration: 'none', border: '1px solid #c4b5fd' },
  achieveGrid: { display: 'flex', gap: '0.4rem', flexWrap: 'wrap' },
  achieveItem: { width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f3ff', fontSize: '1rem', border: '1px solid #ede9fe' },
  statsRow: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.75rem' },
  statCard: { background: 'white', borderRadius: '12px', padding: '0.85rem', boxShadow: '0 3px 12px rgba(139,92,246,0.08)', border: '1px solid #ede9fe', display: 'flex', flexDirection: 'column', gap: '0.4rem' },
  statIcon: { width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  statInfo: { display: 'flex', flexDirection: 'column' },
  statValue: { fontSize: '1.35rem', fontWeight: 700, color: '#1f2937' },
  statLabel: { fontSize: '0.75rem', color: '#6b7280' },
  statTrend: { fontSize: '0.7rem', color: '#7c3aed', display: 'flex', alignItems: 'center', gap: '0.2rem' },
  twoCol: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  skillItem: { display: 'flex', gap: '0.5rem', padding: '0.5rem 0', borderBottom: '1px solid #f3f4f6' },
  skillIcon: { fontSize: '1rem' },
  skillInfo: { flex: 1 },
  skillHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.25rem' },
  skillName: { fontSize: '0.8rem', fontWeight: 600, color: '#374151' },
  badge: { fontSize: '0.65rem', padding: '0.15rem 0.4rem', borderRadius: '4px', fontWeight: 600, textTransform: 'capitalize' },
  progressBar: { height: '5px', background: '#ede9fe', borderRadius: '3px', overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: '3px', transition: 'width 0.5s' },
  skillMeta: { display: 'flex', justifyContent: 'space-between', fontSize: '0.65rem', color: '#9ca3af', marginTop: '0.2rem' },
  jobItem: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.6rem', background: '#faf5ff', borderRadius: '8px', marginBottom: '0.4rem', border: '1px solid #ede9fe' },
  jobLogo: { width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700, fontSize: '0.85rem' },
  jobInfo: { flex: 1, display: 'flex', flexDirection: 'column' },
  jobTitle: { fontSize: '0.8rem', fontWeight: 600, color: '#1f2937' },
  jobMeta: { fontSize: '0.7rem', color: '#6b7280' },
  jobMatch: { fontSize: '0.8rem', fontWeight: 700, color: '#7c3aed', background: '#ede9fe', padding: '0.25rem 0.5rem', borderRadius: '6px' },
  courseGrid: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.6rem' },
  courseItem: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.6rem', background: '#faf5ff', borderRadius: '8px', border: '1px solid #ede9fe' },
  courseIcon: { fontSize: '1.1rem' },
  courseInfo: { flex: 1, display: 'flex', flexDirection: 'column' },
  courseTitle: { fontSize: '0.75rem', fontWeight: 600, color: '#1f2937' },
  courseMeta: { fontSize: '0.65rem', color: '#9ca3af' },
  courseProgress: { fontSize: '0.8rem', fontWeight: 700, color: '#7c3aed' },
  eventItem: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.4rem 0' },
  eventDot: { width: '8px', height: '8px', borderRadius: '50%' },
  eventTitle: { fontSize: '0.75rem', fontWeight: 500, color: '#374151' },
  eventDate: { fontSize: '0.65rem', color: '#9ca3af' },
  activityList: { display: 'flex', flexDirection: 'column', gap: '0.4rem' },
  activityItem: { fontSize: '0.75rem', color: '#6b7280', display: 'flex', alignItems: 'center', gap: '0.35rem', padding: '0.25rem 0' }
};
